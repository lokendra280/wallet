      ...
      child: Column(
        ...
        children: [
          SizedBox(height: Dimensions.NAVBAR_ICON_SIZE, width: Dimensions.NAVBAR_ICON_SIZE,
            child: Image.asset(icon, fit: BoxFit.contain, color: Get.find<MenusController>().currentTab == selectIndex
                  ? Theme.of(context).textTheme.titleLarge.color : ColorResources.nevDefaultColor,
            ),
          ),
          const SizedBox(height: 6.0),
          Text(name, style: TextStyle(color: Get.find<MenusController>().currentTab == selectIndex
